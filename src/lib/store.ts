...
export const PACKAGES: Pkg[] = [
  ...
  { id: "easy_150",      name: "Easy 150 Machine",     tagline: "👑 첫 3일 일 56,400원 · 진짜 수익 가속",           price: 1_490_000, dailyReturn: 47_000,  duration: 30, totalReturn: 1_438_200, tier: "GOD",     unlocksTier: "GOD",    badge: "TOP TIER",   fomo: "잔여 좌석 단 87석", seatsLeft: 87, boostMultiplier: 1.2, perks: ["⚡ 첫 3일 일 56,400원 (보너스 구간)", "Day 4~30 일 47,000원 자동 수확", "GOD 미션 풀 무제한", "출금 한도 월 5,000만원", "AI Bot 24h 가동"] },
  { id: "empire",        name: "EMPIRE",               tagline: "👑🔥 Empire 전용 최대 가속 · Founding 30석 한정",  price: 9_900_000, dailyReturn: 280_000, duration: 30, totalReturn: 8_820_000, tier: "EMPIRE",  unlocksTier: "EMPIRE", badge: "👑 EMPIRE",  fomo: "🔥 Founding 30석 한정",   boostMultiplier: 1.5, perks: ["⚡ 첫 3일 일 420,000원 (Empire 전용 +50%)", "Day 4~30 일 280,000원 자동 수확", "💰 결제 즉시 30만원 출금가능 보너스", "🏆 Founding Member 30석 → 추가 50만원 + 평생 뱃지", "🎯 7일 연속 수확 시 1일치 추가 보너스 1회", "📅 Empire Day(매월 1·15일) Day 4+ 보유자 일수익 +50% 자동", "🏛️ Empire 전용 라운지 + 리더보드"] },
