...
export const OLYMPUS_THEME: SlotTheme = {
  ...
  bgOverlay:
    "linear-gradient(180deg, hsl(45 80% 8% / 0.25) 0%, hsl(var(--background) / 0.55) 55%, hsl(var(--background) / 0.9) 100%)",
};
...
export const WIZARD_THEME: SlotTheme = {
  ...
  bgOverlay:
    "linear-gradient(180deg, hsl(265 70% 10% / 0.30) 0%, hsl(var(--background) / 0.55) 55%, hsl(var(--background) / 0.9) 100%)",
};
...
export const DRAGON_THEME: SlotTheme = {
  ...
  bgOverlay:
    "linear-gradient(180deg, hsl(0 70% 10% / 0.30) 0%, hsl(var(--background) / 0.55) 55%, hsl(var(--background) / 0.9) 100%)",
};
