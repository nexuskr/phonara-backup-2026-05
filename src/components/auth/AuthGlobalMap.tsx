  ...
  const liveMarkers = useMemo(() => {
    const source = (
      feed.length > 0
        ? feed
        : [
            { id: "seed-kr", cc: "KR", nick: "김PHON" },
            { id: "seed-us", cc: "US", nick: "NY Apex" },
            { id: "seed-de", cc: "DE", nick: "Berlin Lord" },
            { id: "seed-sg", cc: "SG", nick: "SG Master" },
          ]
    ).slice(0, 6);
    ...
    <div className="relative rounded-2xl border border-gold/35 bg-background/95 overflow-hidden">
      ...
      <div className="flex items-center justify-between px-3 py-2 border-b border-gold/20">
        <div className="inline-flex items-center gap-1.5">
          ...
          <span className="text-[10px] font-black tracking-[0.28em] text-foreground">
            GLOBAL EMPIRE MAP
          </span>
        </div>
      ...
      {/* Map area */}
      <div className="relative h-50 sm:h-[240px] lg:h-[260px] w-full overflow-hidden bg-[radial-gradient(circle_at_50%_46%,hsl(var(--gold)/0.08),transparent_54%)]">
        <style>{`
        ...
        >
          ...
          <rect
            width="1000"
            height="420"
            fill="url(#empire-grid)"
            opacity="0.85"
          />

          <g
            fill="hsl(var(--gold) / 0.10)"
            stroke="hsl(var(--gold) / 0.26)"
            strokeWidth="1.4"
            ...
            >
              <span
                ...
                style={{
                  ...
                  boxShadow:
                    "0 0 0 2px hsl(var(--gold) / 0.85), 0 0 14px hsl(var(--gold) / 0.55)",
