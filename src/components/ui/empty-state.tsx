 ...
 *
 * If `title` is omitted, falls back to i18n `common.empty` so every screen
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1">
        ...
        {resolvedDescription && (
          <p className="text-xs text-muted-foreground max-w-xs leading-relaxed">{resolvedDescription}</p>
        )}
      </div>
