...
const FAQ = [
  { q: "FREE 회원도 진짜 무료인가요? 결제 압박 없나요?", a: "네, 100% 무료입니다. FREE 등급은 평생 무료이며 결제 권유 팝업, 광고, 압박 없이 매일 8개 미션과 게임 3종을 즐기실 수 있습니다. 신규가입 5,000원도 즉시 지급됩니다." },
  { q: "출금은 얼마나 걸리나요?", a: "관리자 승인 후 평균 12분, 최대 1시간 이내 자동 정산됩니다. VIP 이상은 24/7 즉시 정산이 적용됩니다." },
  { q: "출금 한도는 어떻게 되나요?", a: "FREE 월 50만원, STARTER 100만원, PRO 300만원, VIP 500만원, GOD 5,000만원, EMPIRE/PHANTOM은 무제한입니다." },
  { q: "VIP 패키지는 어떻게 작동하나요?", a: "패키지 가입 후 매일 정해진 시간에 자동 정산되며, 등급에 따라 더 높은 보상의 미션이 잠금 해제됩니다. 30~50일간 매일 입금 후 원금+수익 회수." },
  { q: "EMPIRE / PHANTOM의 수익 분배는 진짜인가요?", a: "EMPIRE는 플랫폼 전체 수익의 10%를, PHANTOM SYNDICATE는 15%를 매주 정산일에 자동 분배합니다. 분배 내역은 마이페이지에서 투명하게 확인 가능합니다." },
  { q: "코인(USDT) 출금 시 거래코드란?", a: "관리자 승인 후 발급되는 PM-XXXXXXXX 형태의 코드로 USDT 전송이 추적됩니다. TRC20 / ERC20 / BEP20 네트워크 모두 지원." },
  { q: "출금 비밀번호를 잊어버렸어요", a: "고객센터 1:1 채팅으로 본인 인증(실명+휴대폰 인증) 후 24시간 이내 재설정 가능합니다." },
  { q: "친구 추천 보상은 어떻게 되나요?", a: "추천 시 친구는 5,000원, 본인은 5,000원 + 친구 수익의 5% 평생 페이백을 받습니다. PRO 이상부터는 10% 페이백." },
  { q: "보안은 안전한가요?", a: "256bit 금융급 암호화 + ISO 27001 보안 인증 + 6자리 인증번호 + 6자리 출금비밀번호 2단계 인증으로 운영됩니다." },
  { q: "환불 정책이 궁금합니다", a: "패키지 가입 후 24시간 이내 미사용 시 100% 환불, 이후엔 잔여 회차 비례 환불됩니다. 1:1 채팅으로 신청해주세요." },
];
