...
import { ShieldCheck, Users, TrendingUp, ArrowDownToLine, ArrowUpFromLine, X, Plus, MessageSquare, Send, Coins, Target, Crown, BarChart3, ShieldAlert, Funnel } from "lucide-react";
...
export default function Admin() {
  ...
  const tabs: { id: Tab; label: string; icon: any }[] = [
    ...
    { id: "funnel", label: "전환 깔때기", icon: Funnel },
