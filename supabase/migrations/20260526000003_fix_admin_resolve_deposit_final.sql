-- ============================================================================
-- Migration: 20260526000003_fix_admin_resolve_deposit_final
-- Description:
--   Phase A 1단계 - 입금 승인 신뢰성 고도화
--   - transactions 기준 idempotency 적용
--   - 불일치 상태 fail-closed 처리
--   - wallet_balances FOR UPDATE + 자동 생성 유지
--   - balance_after, available_after 기록 유지
--   - request_status_history 유지
--   - coin 입금 시 profiles 보정 유지
-- ============================================================================
